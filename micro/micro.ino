...
CModbusRTUConnectorInit   mbInit = {.type=_CMODBUSRTUCONNECTOR, .timeout=5000, .rx=2, .tx=3, .rate=2400};
...
CWaterDisplayInit         disInit = {.type=_CWATERDISPLAY, .vs_address=0, .cw_address=18, .hw_address=20};
